...
def sala_detalle(edificio, nombre_sala):
    ...
    # Recursos (si no tenés tabla, dejamos vacío)
    recursos = []

    # Todos los turnos como 'Libre' (luego podés cruzar con reservas)
    ...
    return render_template("sala.html", sala=sala, recursos=recursos, horarios=horarios)
