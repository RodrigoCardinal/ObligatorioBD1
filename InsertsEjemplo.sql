...
INSERT INTO ObligatorioBD1.login (correo, contraseña, es_administrador) VALUES
...
-- Tabla: edificio
INSERT INTO ObligatorioBD1.edificio (nombre_edificio, direccion, departamento) VALUES
...
INSERT INTO ObligatorioBD1.programa_academico (nombre_programa, id_facultad, tipo) VALUES
...
-- Tabla: participante
INSERT INTO ObligatorioBD1.participante(ci, nombre, apellido, email) VALUES
...
INSERT INTO ObligatorioBD1.participante_programa_academico (id_alumno_programa, ci_participante, nombre_programa, rol) VALUES
...
-- Tabla: sala
INSERT INTO ObligatorioBD1.sala (nombre_sala, edificio, capacidad, tipo_sala) VALUES
...
-- Tabla: turno
INSERT INTO ObligatorioBD1.turno (hora_inicio, hora_fin) VALUES
('08:00', '09:00'),
('09:00', '10:00'),
('10:00', '11:00'),
('12:00', '13:00'),
...
INSERT INTO ObligatorioBD1.sancion_participante (ci_participante, fecha_inicio, fecha_fin) VALUES
